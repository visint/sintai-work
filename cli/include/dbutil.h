...
bool_t getUserDataFromDB(uchar_t chassis,uchar_t slot,unit_user_data_t *udata);
bool_t getUserDataByGbk(uchar_t chassis,uchar_t slot,unit_user_data_t *udata);
/*********************************************************************************
...
************************************************************************************/
bool_t setUserDataItemToDB(uchar_t chassis,uchar_t slot,int item_id,const char *udata);
