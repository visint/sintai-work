...
extern int sendMsgQ(msgbuf_t sndbuf,bool_t watting,uchar_t timeout);
extern int sendMsgToCC(msgbuf_t sndbuf,bool_t watting,uchar_t timeout);
...
extern bool_t getUnitClassType(uchar_t chassis,uchar_t slot,uchar_t *uclass,uchar_t *utype);
extern uchar_t *getUnitStatusFromShm(uchar_t chassis);
